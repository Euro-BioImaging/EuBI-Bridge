...
pip install --pre "eubi-bridge==0.1.2b6" # installs both GUI and CLI
...
pip install --no-cache-dir --pre "eubi-bridge==0.1.2b6"
# If a previous version of eubi-bridge was installed before, reset the configuration:
eubi reset_config
```
...
pip install --no-cache-dir --pre "eubi-bridge==0.1.2b6" # try installing again with the dependencies available
# If a previous version of eubi-bridge was installed before, reset the configuration:
eubi reset_config
````
