...
pip install 'eubi-bridge[all]==0.1.0c6' # installs both GUI and CLI
# OR
# pip install 'eubi-bridge[cli]==0.1.0c6' # installs only CLI
# pip install 'eubi-bridge[gui]==0.1.0c6' # installs only GUI
# pip install 'eubi-bridge==0.1.0c6' # installs as a Python library, without GUI or CLI utilities.
#
...
pip install --no-cache-dir 'eubi-bridge[all]==0.1.0c6'
# If a previous version of eubi-bridge was installed before, reset the configuration:
eubi reset_config
```
...
pip install --no-cache-dir "eubi-bridge[all]==0.1.0c6" # try installing again with the dependencies available
# If a previous version of eubi-bridge was installed before, reset the configuration:
eubi reset_config
````
